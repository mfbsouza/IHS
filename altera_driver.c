...
/* Defining Hardware Memory Access */
static void   *display_r;  // handle to 32-bit output PIO
static void   *switches_;   // handle to 16-bit input PIO
static void   *p_bottons, *display_l, *green_leds, *red_leds;

/* Setting Driver Interface Numbers */
static int     access_count =  0;
static int     MAJOR_NUMBER = 91;

/* Defining Driver Functions and Linking using File*/
...
static int pci_probe(struct pci_dev *dev, const struct pci_device_id *id) {
    ...
    printk(KERN_ALERT "altera_driver: Found Vendor ichar_device_opend: %x\n", vendor);
